...
<div class="container">
    <div class="content">
        ...
        <hr>
        <p style="text-align: center; font-family: 'Times New Roman',serif ">Ми найбільша українська мережа оптик, де ви
            можете отримати професійну консультацію лікаря-офтальмолога,
    ...
    <img src="<c:url value="../../resources/images/glass_on_yellow.jfif"/>" alt="Notebook" style="width:50%;
margin-left: auto; margin-right: auto; display: block;">
</div>

<hr>
<h3 style="text-align: center; font-family: 'Times New Roman',serif">Наші Лікарі</h3>
<hr>
